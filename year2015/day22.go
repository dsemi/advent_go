...
func parseBoss2(input string) *Game {
	var v []int
...
func (Day22) Part1(input string) interface{} {
	return minCostToWin(parseBoss2(input), false)
}

func (Day22) Part2(input string) interface{} {
	return minCostToWin(parseBoss2(input), true)
}

func init() {
	types.Register(Probs, Day22{})
}
